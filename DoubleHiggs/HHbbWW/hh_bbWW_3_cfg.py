...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:PythiaHH_step2.root'),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('step3 nevts:169'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:HH_bbWW_bblnjj.root'),
