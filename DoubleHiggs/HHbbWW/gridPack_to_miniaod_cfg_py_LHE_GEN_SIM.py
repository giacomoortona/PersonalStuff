...
# with command line options: Configuration/GenProduction/python/gridPack_to_miniaod_cfg.py -s LHE,GEN,SIM --conditions auto:mc --datatier GEN-SIM-RAW --eventcontent RAWSIM -n 1000 --no_exec --fileout file:PythiaHH.root
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/gridPack_to_miniaod_cfg.py nevts:1000'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:PythiaHH.root'),
