...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:PythiaHH_step1.root'),
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:PythiaHH_step2.root'),
