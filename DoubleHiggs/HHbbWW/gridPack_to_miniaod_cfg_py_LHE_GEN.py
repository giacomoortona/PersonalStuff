...
# with command line options: Configuration/GenProduction/python/gridPack_to_miniaod_cfg.py -s LHE,GEN --conditions auto:mc --datatier GEN-SIM-RAW --eventcontent RAWSIM -n 1000 --no_exec --fileout file:PythiaHH.root
